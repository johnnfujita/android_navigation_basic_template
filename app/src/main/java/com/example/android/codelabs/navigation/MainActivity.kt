...
class MainActivity : AppCompatActivity() {
    ...
    // so beyond simply configuring the navigation view like for the bottom one, we must configure that sandwich and what top level
    // navigation items will be inserted without the up arrow
